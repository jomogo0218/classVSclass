...
def ultimate_v10_full_restore():
    print("Executing Ultimate V10 Full Restore (Solving ReferenceError + Restoring All Buttons)...")
    ...
    c.innerHTML = `
        <div class="rr-dashboard">
            ...
            <div class="rr-leaderboard">
                <div style="font-weight:800; margin-bottom:15px;">🏆 排行榜</div>
...
"""
    ...
    print("V10 ULTIMATE RESTORE COMPLETE!")

if __name__ == "__main__":
    ultimate_v10_full_restore()
