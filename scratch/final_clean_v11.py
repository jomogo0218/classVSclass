...
def final_clean_v11():
    print("Executing Final Clean V11 (Removing ALL external app.js references)...")
...
"""
    ...
    # 5. 強力清理 HTML 並注入
    # 使用超強 regex 移除所有可能的外部 script 標籤
    ...
    print("V11 CLEAN BUILD COMPLETE! All external links purged.")
