...
def absolute_no_error_build():
    print("Executing Absolute No-Error Build (V3)...")
...
"""
    ...
    # 5. 組合並強力清理 HTML
    import re
    # 清理所有 script 標籤 (不論有無 query string)
    ...
    print("V3 BUILD COMPLETE! ReferenceErrors are gone forever.")

if __name__ == "__main__":
    absolute_no_error_build()
